...
This installer downloads the latest source, installs it under
`~/.local/share/lin-dos`, and appends the LIN-DOS loader to `~/.bashrc`.

Then load commands in your current shell:
